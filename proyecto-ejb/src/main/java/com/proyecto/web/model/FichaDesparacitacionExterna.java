 ...
 */
@Entity
@Table(name = "ficha_desparacitacion_externa")
public class FichaDesparacitacionExterna implements Serializable {
    ...
    @Column(name = "dee_fecha")
    @Temporal(TemporalType.TIMESTAMP)
    private Date fecha;

    @Column(name = "dee_peso")
    private BigDecimal peso;

    @Column(name = "dee_producto")
    private String producto;

    @Column(name = "dee_fecha_proxima")
    @Temporal(TemporalType.TIMESTAMP)
    ...
    public FichaDesparacitacionExterna() {
    }
